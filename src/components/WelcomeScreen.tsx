...
import { Shield, ArrowRight, LogIn, Sparkles, Globe } from 'lucide-react';
...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#07080b] text-slate-100 px-4 overflow-hidden select-none bg-ambient-deck">
      ...
      <div className="absolute w-[550px] h-[550px] bg-emerald-500/10 rounded-full blur-[130px] pointer-events-none -top-20" />
      <div className="absolute w-[450px] h-[450px] bg-violet-500/10 rounded-full blur-[110px] pointer-events-none -bottom-20" />
      ...
      <div className="relative z-10 flex flex-col items-center max-w-lg w-full text-center space-y-6 animate-in fade-in zoom-in-95 duration-500">
        {/* Minimal Shield Logo with Ambient Aura */}
        <div className="relative">
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-emerald-500/20 via-emerald-500/10 to-violet-500/15 border border-emerald-500/30 flex items-center justify-center shadow-[0_0_50px_rgba(16,185,129,0.25)]">
        ...
        <div className="space-y-3">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-[11px] font-mono font-bold tracking-wider uppercase">
            <Sparkles className="w-3 h-3 text-emerald-400" />
            <span>Minecraft Java • Fabric SMP</span>
          </span>
        ...
        {/* Status Pill */}
        <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-2xl bg-black/40 border border-white/10 text-xs font-mono text-slate-300">
          <span
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-sm pt-2">
          <button
            ...
            className="w-full sm:flex-1 py-3 px-6 rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-400 hover:from-emerald-400 hover:to-emerald-300 text-black font-extrabold text-xs tracking-wide transition-all flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(16,185,129,0.35)] cursor-pointer group"
          >
          ...
          <button
            ...
            className="w-full sm:flex-1 py-3 px-6 rounded-2xl bg-white/[0.05] hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-bold text-xs tracking-wide transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
